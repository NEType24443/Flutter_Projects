...
//class BluetoothConnectPage extends StatefulWidget {
//  //static String id = 'bluetooth_connect_page';
//  BluetoothConnectPage({Key key, this.title}) : super(key: key);
//
//  final String title;
//  final FlutterBlue flutterBlue = FlutterBlue.instance;
//  final List<BluetoothDevice> devicesList = new List<BluetoothDevice>();
...
//            ),
//            onPressed: () {
//              print('\n ConnectedDevice: ${_connectedDevice.name.toString()} \n');
////            Navigator.pushReplacementNamed(context, '/', arguments: _connectedDevice.name.toString());
//              Navigator.pushReplacement(
//                  context,
//                  MaterialPageRoute(
//                      builder: (BuildContext context) {
